...
//    
    ...
    /*
    double DFuud1 = 2.*FF->xfxQ2(2, z2, mub2)/z2 * pdf->xfxQ2(2,xq, mub2) + FF->xfxQ2(1, z2, mub2)/z2 * pdf->xfxQ2(1,xq, mub2);
    double DFuudDg1 = DFuud1 * FF->xfxQ2(21, z1, mub2)/z1;
    double DFuud2 = 2.*FF->xfxQ2(2, z1, mub2)/z1 * pdf->xfxQ2(2,xq, mub2) + FF->xfxQ2(1, z1, mub2)/z1 * pdf->xfxQ2(1,xq, mub2);
    ...
    double DFggg = FF->xfxQ2(21, z1, mub2)/z1 * pdf->xfxQ2(21,xq, mub2) * FF->xfxQ2(21, z2, mub2)/z2;
    */
    ...
    double DFuud1 = u2/z2 * pdf->xfxQ2(2,xq, mub2) + d2/z2 * pdf->xfxQ2(1,xq, mub2);
    double DFuudDg1 = DFuud1 * gl1/z1;
    double DFuud2 = u1/z1 * pdf->xfxQ2(2,xq, mub2) + d1/z1 * pdf->xfxQ2(1,xq, mub2);
    double DFuudDg2 = DFuud2 * gl2/z2;
    double TwofgDqDq = 2.*pdf->xfxQ2(21,xq, mub2) * (
                       u1/z1 * u2/z2 + d1/z1 * d2/z2 
                       );
    double DFggg = gl1/z1 * pdf->xfxQ2(21,xq, mub2) * gl2/z2;
...
//    inter_FadjVt = exp(inter_FadjVt);
    ...
    /*
    double sumq =  2.*pdf->xfxQ2(2,xq, Q2) * FF->xfxQ2(2, z1, Q2)/z1 + pdf->xfxQ2(1,xq, Q2) * FF->xfxQ2(1, z1, Q2)/z1;
    ...
    */
    ...
    double sumq =  pdf->xfxQ2(2,xq, Q2) * u1/z1 + pdf->xfxQ2(1,xq, Q2) * d1/z1;
    double sumg =  pdf->xfxQ2(21,xq, Q2) * gl1/z1;
